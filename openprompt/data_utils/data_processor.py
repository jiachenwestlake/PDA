...
class DataProcessor:
    ...
    def get_train_pos_examples(self, data_dir) -> InputExample:
        return self.get_examples(data_dir, "pos")

    def get_train_neg_examples(self, data_dir) -> InputExample:
        return self.get_examples(data_dir, "neg")

    def get_train_ent_examples(self, data_dir) -> InputExample:
        return self.get_examples(data_dir, "ent")

    def get_train_neu_examples(self, data_dir) -> InputExample:
        return self.get_examples(data_dir, "neu")

    def get_train_con_examples(self, data_dir) -> InputExample:
        return self.get_examples(data_dir, "con")
